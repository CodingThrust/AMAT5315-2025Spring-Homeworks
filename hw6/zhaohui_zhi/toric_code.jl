...
using Arpack
val,vec = eigs(-mat(h), nev = 10, which=:SR)
using KrylovKit
valkry, veckry = eigsolve(-mat(h), 10, :SR)

v1,v2=eigs(-mat(toric_code_hamiltonian(2,2)), nev = 10, which=:SR)
v12, v22 = eigsolve(-mat(toric_code_hamiltonian(2,2)), 10, :SR)