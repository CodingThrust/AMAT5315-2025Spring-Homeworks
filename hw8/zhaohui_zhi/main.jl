...
initial_scale = 0.1 
initial_x = [1.0, 0.0, 0.0, 1.0, 1.0] # Initial state for the x and y variables
...
nsteps = 1000
dt = 0.01
state, checkpoints = simulate_bifurcation!(initial_state, bifurcation_model; nsteps=nsteps, dt=dt,  checkpoint_steps=10)
